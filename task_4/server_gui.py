...
if __name__ == '__main__':
    ...
    test_list.appendRow(
        [QStandardItem('test1'), QStandardItem('192.198.0.111'), QStandardItem('23544'), QStandardItem('16:20:34')])
    test_list.appendRow(
        [QStandardItem('test2'), QStandardItem('192.198.0.115'), QStandardItem('33245'), QStandardItem('16:22:11')])
